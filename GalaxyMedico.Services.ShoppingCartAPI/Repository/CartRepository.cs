...
namespace GalaxyMedico.Services.ShoppingCartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<CartDto> CreateUpdateCart(CartDto cartDto)
        {
            ...
            var prodInDb = await _db.Drugs
                .FirstOrDefaultAsync(u => u.DrugId == cartDto.CartDetails.FirstOrDefault()
                .DrugId);
            if (prodInDb == null)
            {
                _db.Drugs.Add(cart.CartDetails.FirstOrDefault().Drug);
                await _db.SaveChangesAsync();
            }
            ...
            if (cartHeaderFromDb == null)
            {
                ...
                cart.CartDetails.FirstOrDefault().Drug = null;
            ...
            else
            {
                ...
                var cartDetailsFromDb = await _db.CartDetails.AsNoTracking().FirstOrDefaultAsync(
                    u => u.DrugId == cart.CartDetails.FirstOrDefault().DrugId &&
        ...
        public async Task<CartDto> GetCartByUserId(string userId)
        {
            ...
            cart.CartDetails = _db.CartDetails
                 .Where(u => u.CartHeaderId == cart.CartHeader.CartHeaderId).Include(u => u.Drug);
